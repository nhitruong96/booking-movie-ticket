...
export default function Footer(props) {
  ...
  const arrayTheaters = _.map(arrTheater, (theater) => _.pick(theater, ['maHeThongRap', 'tenHeThongRap', 'logo']));
      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start text-white">
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="flex-shrink-0 w-5 h-5 rounded-full dark:text-gray-900" data-darkreader-inline-fill style={{ darkreaderInlineFill: 'currentColor' }}>
              ...
              <span className="self-center text-2xl font-semibold">Cinemagic</span>
            </a>
          </div>
            ...
            <div className="grid grid-cols-3" style={{ color: '#fff' }}>
              {arrayTheaters.map((item, index) => {
                return <div key={index}>
                  <img src={item.logo} alt={item.tenHeThongRap} style={{ width: 50 }} />
                </div>
              })}
            </div>
          </div>
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          ...
          {/* <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" data-darkreader-inline-fill style={{ darkreaderInlineFill: 'currentColor' }}>
            ...
            <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-5 h-5" data-darkreader-inline-fill style={{ darkreaderInlineFill: 'currentColor' }}>
            ...
            <a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5" data-darkreader-inline-fill style={{ darkreaderInlineFill: 'currentColor' }}>
